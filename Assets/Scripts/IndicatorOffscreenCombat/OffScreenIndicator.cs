...
namespace GameStudio.HunterGatherer.OffScreenIndicator
{
    ...
    public class OffScreenIndicator : MonoBehaviour
    {
        ...
        void DrawIndicators()
        {
            ...
            {
                if (target.Division.IsMine/* && (target.Division.Goal == DivisionGoal.Defend || target.Division.Goal == DivisionGoal.Idle)*/)
                {
                    ...
                    if (indicator)
                    {
                        if(target.Division.Goal == DivisionGoal.Defend)
                        {
                            indicator.SetImageColor(target.DefendColor);
                        }
                        else
                        { 
                    ...
                    if (isTargetVisible /*|| target.Division.Goal != DivisionGoal.Defend || target.Division.Units.Count == 0*/)
                    {
