...
namespace GameStudio.HunterGatherer.OffScreenIndicator
{
    ...
    public class Target : MonoBehaviour
    {
        ...
        [Tooltip("Change this color to change the indicators color for this defending target")]
        [SerializeField] private Color defendColor = Color.red;
        ...
        private Division returnableDivision;
        /// <summary>
        ...
        private void Awake()
        {
            returnableDivision = GetComponent<Division>();
        }
