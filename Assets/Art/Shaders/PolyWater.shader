/*
 * Source: https://www.battlemaze.com/?p=590
 * Changes: - Minor changes to the default values.
 *          - Disabeld vertex displacement in line 153, due to fog issues.
 */
Shader "LowPoly/LowPolyWater" 
{
	Properties
	{
		_Color("Color", Color) = (1, 1, 1, 1)
		_Smoothness("Smoothness", Range(0, 1)) = 0.919
		_Metallic("Metallic", Range(0,1)) = 0.218

		_GIntensity("Per vertex displacement", Float) = 0.2
		_GAmplitude("Wave Amplitude", Vector) = (0.69, 0.50, 0.60, 0.31)
		_GFrequency("Wave Frequency", Vector) = (0.88, 0.34, 0.40, 1.85)
		_GSteepness("Wave Steepness", Vector) = (3.00, 3.67, 1.00, 1.00)
		_GSpeed("Wave Speed", Vector) = (1.27, 1.3, -0.3, 1)
		_GDirectionAB("Wave Direction", Vector) = (0.40, 0.10, 0.99, 0.20)
		_GDirectionCD("Wave Direction", Vector) = (1.00, 0.50, 1.13,-0.21)

		_RandomHeight("Random height", Float) = 0.20
		_RandomSpeed("Random Speed", Float) = 3   
	}
